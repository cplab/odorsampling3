...
"""
    class Activation:
        #Class to encapsulate different types of activation functions.
        ...
        @staticmethod
        def gaussian(mu, sigma, **_):
            #Returns a random floating number with gaussian distribution.
            return RNG.normal(mu, sigma)

        @staticmethod
        def choice_gauss(mu, sigma, **_):
            #Returns a random floating number with gaussian distribution multiplied by either 1 or -1.
            return RNG.choice([1,-1])*Activation.gaussian(mu, sigma)

        @staticmethod
        def expovar(lambd, **_):
            #Returns a random floating number with exponential distribution.
            return RNG.exponential(1/lambd)
